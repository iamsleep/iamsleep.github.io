...
最後介紹如何直接透過 [api](https://developer.github.com/v3/git/tags/#create-a-tag-object) 產生 tag <img src="{{ site.url }}/images/notice.png" alt="notice" width="1%" hieght="1%"/>只有產生 tag object，repository 尚未被 tag<br/>
{% highlight bash %}

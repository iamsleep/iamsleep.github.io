...
layout: post
title: github api
date: 2015-01-12 11:11:00 +08:00
categories: [git]
---
#### 標題 : {{page.title}} ####
...
<img src="{{ site.url }}/images/github-personal-token.jpg" alt="notice" width="70%" hieght="70%"/>
...
第二種，搜尋 repository ，通常我們只記得片段的 component 名稱，這時候透過 [search](https://developer.github.com/v3/search/) 的功能相當方便，列出所有可能的 repositories<br/> 
<img src="{{ site.url }}/images/notice.png" alt="notice" width="1%" hieght="1%"/> default search result 是 30 個，目前上限是 100。
{% highlight bash %}
...
<img src="{{ site.url }}/images/notice.png" alt="notice" width="1%" hieght="1%"/>只有產生 tag object，repository 尚未被 tag
{% highlight bash %}
